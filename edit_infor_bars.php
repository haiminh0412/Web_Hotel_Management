...
$query = "Select * from information_bars where STT = '$id'";
...
if(isset($_POST['submit'])){
    $update = "UPDATE `information_bars` SET `name`='$name_booking',`phone`='$phone_update',`email`='$email_update',`note`='$note_update' where STT = '$id'";
...
<div class="modal">
    <div class="modal-container">
        <form method="POST" class="form-container" >
            ...
            <input type="button" name="btnback" value="Trở Lại" id="back-button" onclick="window.location.href='info_bars.php?username=<?php echo $username_booking ?>'; return false;" >
