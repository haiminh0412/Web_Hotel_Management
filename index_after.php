        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link About us me-2" href="#" tabindex="-1" aria-disabled="true">About us</a>
              </li>
              <li class="nav-item dropdown" style="margin-left: 570px;">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                 Tài Khoản: <?php session_start(); $username = $_SESSION['username']; echo $username;  ?>
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="history_booking.php">1. Phòng đã đặt</a></li>
                  <li><a class="dropdown-item" href="logout.php" >2. Đăng Xuất</a></li>
                </ul>
              </li>
</ul>
